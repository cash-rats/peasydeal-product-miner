...
CREATE INDEX idx_product_drafts_status_updated
  ON product_drafts(status, updated_at_ms DESC);
CREATE INDEX idx_product_drafts_url
  ON product_drafts(url);
CREATE INDEX idx_product_drafts_source
  ON product_drafts(source);
CREATE INDEX idx_product_drafts_creator_created
  ON product_drafts(created_by, created_at_ms DESC);
CREATE TRIGGER trg_product_drafts_touch_updated_at
