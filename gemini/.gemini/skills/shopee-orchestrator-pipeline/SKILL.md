...
1. `$HOME/.gemini/skills/<skill_name>/SKILL.md`
2. `/gemini/.gemini/skills/<skill_name>/SKILL.md`
3. `gemini/.gemini/skills/<skill_name>/SKILL.md`
...
7. Read `tab_tracking` from `s0-snapshot-pointer.json` (or `s0-manifest.json` fallback) and write verification result into `meta.json`.
