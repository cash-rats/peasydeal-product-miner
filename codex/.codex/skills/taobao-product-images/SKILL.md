---
name: taobao-product-images
description: Parse Taobao snapshot HTML artifacts offline and return a short JSON list of product image URLs.
---

# Taobao Product Images (images_extract)
...
2. Extract product image URLs from HTML/SSR JSON.
